...
Запустите TeleProxy в одном терминале, бот — в другом:
...
Да, вам нужен VPS с настроенным Xray-сервером (VLESS + Reality). Это серверная часть, TeleProxy — только клиент.
