...
2. **Сделайте бинарник исполняемым (если нужно):**
   ```bash
   chmod +x xray-core/xray
   ```

3. **Запустите** (один из способов):
   ```bash
...
4. **Настройте Telegram:** Settings → Data and Storage → Proxy → SOCKS5 → Host: `127.0.0.1`, Port: `2080`
